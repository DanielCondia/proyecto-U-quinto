        ...
        <div class="col" style="margin-top: 3rem;">
            <div class="input-group">
                <input id="entradafilter" type="text" class="form-control" placeholder="FILTRAR"
                       data-bs-toggle="mensaje"
                       title="aca podras filtrar tus notas ya sea con el titulo o con la fecha">
            </div>
            ...
            <a href="#agregar" data-bs-toggle="collapse" class="btn btn-outline-primary" data-bs-toggle="mensaje"
               title="se desplegara un formulario para agregar tu nota">Agregar</a>
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" name="titulo" id="titulo" required
                                   data-bs-toggle="mensaje"
                                   title="coloca un titulo corto con eso te sera mas facil buscar la nota despues">
                        </div>
                        <div class="col-3">
                            <label for="categoria" class="form-label">categoria</label>
                            <input type="text" class="form-control" name="categoria" id="categoria" required
                                   data-bs-toggle="mensaje" title="aca escribe una categoria como trabajo o estudio">
                        </div>
                        <div class="col-3">
